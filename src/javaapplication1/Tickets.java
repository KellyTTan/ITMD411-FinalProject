...
public class Tickets extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 */
			...
			String ticketId = JOptionPane.showInputDialog(null, "Please enter the ticket ID");
			...
			String ticketName = JOptionPane.showInputDialog(null, "Please enter the ID you'd like the update");
			String ticketDesc = JOptionPane.showInputDialog(null, "Add to the ticket description");
			...
			String ticketId = JOptionPane.showInputDialog(null, "Please enter the ticket id you'd like to delete");
			// retrieve all tickets details for viewing in JTable
			
			if(ticketId == null) {
				JOptionPane.showMessageDialog(null,  "Ticket failed to delete");
				System.out.println("ticket failed to delet");
			} else {
				int tid = Integer.parseInt(ticketId);
				int reply = JOptionPane.showConfirmDialog(null, "are you sure you would like to delete ticket " + tid + "?", "Warning!", JOptionPane.YES_NO_OPTION);
				if (reply == JOptionPane.YES_OPTION) {
					int id = dao.deleteRecords(tid);
					if (id !=0) {
						System.out.println("Ticket ID: " +id+ " was successfully deleted.");
						JOptionPane.showMessageDialog(null,  "Ticket ID: " +id+ " was successfully deleted.");	
					} else {
